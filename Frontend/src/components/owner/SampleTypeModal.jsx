// src/components/owner/SampleTypeModal.jsx
      ...
      <div className={modalBox} onMouseDown={(e) => e.stopPropagation()}>
        <div className="p-6 border-b border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900">
            {isEdit ? "Edit Sample Type" : "Add Sample Type"}
          </h3>
          <p className="text-sm text-gray-500 mt-1">
            Master list used across all clinics and dentists.
          </p>
        </div>
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="text-xs text-gray-500">
                  Inactive sample types can be hidden from selection.
                </div>
              </div>
